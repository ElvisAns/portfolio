    ...
    <main v-if="article" class="max-w-[1280px] mx-auto px-[20px] mt-[40px] text-black dark:text-white">
        ...
        <div class="mb-12">
            ...
            <div class="flex items-center gap-6 text-sm text-gray-500 dark:text-gray-400">
                ...
                <a :href="`https://dev.to/elvisans/managing-permissions-in-laravel-applications-using-spatie-1le`" target="_blank" class="flex items-center gap-1">
        ...
        <div class="flex items-center gap-4 mb-12">
            ...
            <a :href="`https://twitter.com/intent/tweet?text=Managing permissions in Laravel applications using Spatie/laravel-permission&url=${currentUrl}`" target="_blank"
        ...
        <div class="flex items-center gap-4 mb-12 prose dark:prose-invert prose-lg">
            <p>You can like and comment this article on <a :href="`https://dev.to/elvisans/managing-permissions-in-laravel-applications-using-spatie-1le`"
...
const { setSeo } = useSeo()
setSeo({
    title: `Managing permissions in Laravel applications using Spatie/laravel-permission | Ansima's Blog`,
    description: `In this post, I'll share my approach to managing roles and permissions in Laravel apps.  I will be...`,
    image: `https://media2.dev.to/dynamic/image/width=1000,height=500,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Fuvp2hg4xcz8cqfccsgdy.jpg`,
    type: 'article'
})
...
onMounted(async () => {
    try {
        const articleResponse = await fetch(`https://dev.to/api/articles/elvisans/managing-permissions-in-laravel-applications-using-spatie-1le`)
