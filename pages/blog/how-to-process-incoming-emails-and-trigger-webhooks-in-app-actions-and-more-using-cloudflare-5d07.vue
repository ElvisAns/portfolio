    ...
    <main v-if="article" class="max-w-[1280px] mx-auto px-[20px] mt-[40px] text-black dark:text-white">
        ...
        <div class="mb-12">
            ...
            <div class="flex items-center gap-6 text-sm text-gray-500 dark:text-gray-400">
                ...
                <a :href="`https://dev.to/elvisans/how-to-process-incoming-emails-and-trigger-webhooks-in-app-actions-and-more-using-cloudflare-5d07`" target="_blank" class="flex items-center gap-1">
        ...
        <div class="flex items-center gap-4 mb-12">
            ...
            <a :href="`https://twitter.com/intent/tweet?text=How to Process Incoming Emails and Trigger Webhooks, In-App Actions, and More Using Cloudflare Email Workers and D1 Database&url=${currentUrl}`" target="_blank"
        ...
        <div class="flex items-center gap-4 mb-12 prose dark:prose-invert prose-lg">
            <p>You can like and comment this article on <a :href="`https://dev.to/elvisans/how-to-process-incoming-emails-and-trigger-webhooks-in-app-actions-and-more-using-cloudflare-5d07`"
...
const { setSeo } = useSeo()
setSeo({
    title: `How to Process Incoming Emails and Trigger Webhooks, In-App Actions, and More Using Cloudflare Email Workers and D1 Database | Ansima's Blog`,
    description: `It's common to have shared mailboxes across teams in companies, eg. contact emails or support...`,
    image: `https://media2.dev.to/dynamic/image/width=1000,height=500,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Ff04mbte5t7fj3c2fa2og.jpg`,
    type: 'article'
})
...
onMounted(async () => {
    try {
        const articleResponse = await fetch(`https://dev.to/api/articles/elvisans/how-to-process-incoming-emails-and-trigger-webhooks-in-app-actions-and-more-using-cloudflare-5d07`)
