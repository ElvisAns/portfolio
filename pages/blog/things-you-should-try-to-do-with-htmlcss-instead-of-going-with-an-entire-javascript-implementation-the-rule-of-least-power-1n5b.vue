    ...
    <main v-if="article" class="max-w-[1280px] mx-auto px-[20px] mt-[40px] text-black dark:text-white">
        ...
        <div class="mb-12">
            ...
            <div class="flex items-center gap-6 text-sm text-gray-500 dark:text-gray-400">
                ...
                <a :href="`https://dev.to/elvisans/things-you-should-try-to-do-with-htmlcss-instead-of-going-with-an-entire-javascript-implementation-the-rule-of-least-power-1n5b`" target="_blank" class="flex items-center gap-1">
        ...
        <div class="flex items-center gap-4 mb-12">
            ...
            <a :href="`https://twitter.com/intent/tweet?text=Things you should try to do with HTML/CSS to avoid JavaScript overuse : The rule of least power&url=${currentUrl}`" target="_blank"
        ...
        <div class="flex items-center gap-4 mb-12 prose dark:prose-invert prose-lg">
            <p>You can like and comment this article on <a :href="`https://dev.to/elvisans/things-you-should-try-to-do-with-htmlcss-instead-of-going-with-an-entire-javascript-implementation-the-rule-of-least-power-1n5b`"
...
const { setSeo } = useSeo()
setSeo({
    title: `Things you should try to do with HTML/CSS to avoid JavaScript overuse : The rule of least power | Ansima's Blog`,
    description: `The rule of least power in web development is simple: whenever possible, try to use the least...`,
    image: `https://media2.dev.to/dynamic/image/width=1000,height=500,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2F1c38qf9mufe02ljdtr28.jpg`,
    type: 'article'
})
...
onMounted(async () => {
    try {
        const articleResponse = await fetch(`https://dev.to/api/articles/elvisans/things-you-should-try-to-do-with-htmlcss-instead-of-going-with-an-entire-javascript-implementation-the-rule-of-least-power-1n5b`)
