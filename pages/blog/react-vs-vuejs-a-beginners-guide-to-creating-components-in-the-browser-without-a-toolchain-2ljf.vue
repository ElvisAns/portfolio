    ...
    <main v-if="article" class="max-w-[1280px] mx-auto px-[20px] mt-[40px] text-black dark:text-white">
        ...
        <div class="mb-12">
            ...
            <div class="flex items-center gap-6 text-sm text-gray-500 dark:text-gray-400">
                ...
                <a :href="`https://dev.to/elvisans/react-vs-vuejs-a-beginners-guide-to-creating-components-in-the-browser-without-a-toolchain-2ljf`" target="_blank" class="flex items-center gap-1">
        ...
        <div class="flex items-center gap-4 mb-12">
            ...
            <a :href="`https://twitter.com/intent/tweet?text=React vs Vue.js: A Beginner's Guide to Creating Components in the Browser without a Toolchain&url=${currentUrl}`" target="_blank"
        ...
        <div class="flex items-center gap-4 mb-12 prose dark:prose-invert prose-lg">
            <p>You can like and comment this article on <a :href="`https://dev.to/elvisans/react-vs-vuejs-a-beginners-guide-to-creating-components-in-the-browser-without-a-toolchain-2ljf`"
...
const { setSeo } = useSeo()
setSeo({
    title: `React vs Vue.js: A Beginner's Guide to Creating Components in the Browser without a Toolchain | Ansima's Blog`,
    description: `Disclaimer : This article was created with the help of AI  In web development, a toolchain is a fancy...`,
    image: `https://media2.dev.to/dynamic/image/width=1000,height=500,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2F5bzhh0khtzvz5cpscbka.png`,
    type: 'article'
})
...
onMounted(async () => {
    try {
        const articleResponse = await fetch(`https://dev.to/api/articles/elvisans/react-vs-vuejs-a-beginners-guide-to-creating-components-in-the-browser-without-a-toolchain-2ljf`)
