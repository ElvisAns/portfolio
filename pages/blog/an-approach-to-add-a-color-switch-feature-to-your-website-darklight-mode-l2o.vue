    ...
    <main v-if="article" class="max-w-[1280px] mx-auto px-[20px] mt-[40px] text-black dark:text-white">
        ...
        <div class="mb-12">
            ...
            <div class="flex items-center gap-6 text-sm text-gray-500 dark:text-gray-400">
                ...
                <a :href="`https://dev.to/elvisans/an-approach-to-add-a-color-switch-feature-to-your-website-darklight-mode-l2o`" target="_blank" class="flex items-center gap-1">
        ...
        <div class="flex items-center gap-4 mb-12">
            ...
            <a :href="`https://twitter.com/intent/tweet?text=An overview of how to implement a colour toggle function in your web applications (dark / light mode)&url=${currentUrl}`" target="_blank"
        ...
        <div class="flex items-center gap-4 mb-12 prose dark:prose-invert prose-lg">
            <p>You can like and comment this article on <a :href="`https://dev.to/elvisans/an-approach-to-add-a-color-switch-feature-to-your-website-darklight-mode-l2o`"
...
const { setSeo } = useSeo()
setSeo({
    title: `An overview of how to implement a colour toggle function in your web applications (dark / light mode) | Ansima's Blog`,
    description: `Introduction:   In modern web development, it's very necessary to allow users to customize...`,
    image: `https://media2.dev.to/dynamic/image/width=1000,height=500,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Fk1wbmuesdt7qmyjhlkoh.png`,
    type: 'article'
})
...
onMounted(async () => {
    try {
        const articleResponse = await fetch(`https://dev.to/api/articles/elvisans/an-approach-to-add-a-color-switch-feature-to-your-website-darklight-mode-l2o`)
