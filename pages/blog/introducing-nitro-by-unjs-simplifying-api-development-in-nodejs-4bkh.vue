    ...
    <main v-if="article" class="max-w-[1280px] mx-auto px-[20px] mt-[40px] text-black dark:text-white">
        ...
        <div class="mb-12">
            ...
            <div class="flex items-center gap-6 text-sm text-gray-500 dark:text-gray-400">
                ...
                <a :href="`https://dev.to/elvisans/introducing-nitro-by-unjs-simplifying-api-development-in-nodejs-4bkh`" target="_blank" class="flex items-center gap-1">
        ...
        <div class="flex items-center gap-4 mb-12">
            ...
            <a :href="`https://twitter.com/intent/tweet?text=Introducing Nitro by @unjs: Simplifying API Development in Nodejs&url=${currentUrl}`" target="_blank"
        ...
        <div class="flex items-center gap-4 mb-12 prose dark:prose-invert prose-lg">
            <p>You can like and comment this article on <a :href="`https://dev.to/elvisans/introducing-nitro-by-unjs-simplifying-api-development-in-nodejs-4bkh`"
...
const { setSeo } = useSeo()
setSeo({
    title: `Introducing Nitro by @unjs: Simplifying API Development in Nodejs | Ansima's Blog`,
    description: `If you have ever built an API with Express, you know the effort it takes to have a clean project...`,
    image: `https://media2.dev.to/dynamic/image/width=1000,height=500,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2F7zxwnx7m58zjxkw9ewt9.png`,
    type: 'article'
})
...
onMounted(async () => {
    try {
        const articleResponse = await fetch(`https://dev.to/api/articles/elvisans/introducing-nitro-by-unjs-simplifying-api-development-in-nodejs-4bkh`)
