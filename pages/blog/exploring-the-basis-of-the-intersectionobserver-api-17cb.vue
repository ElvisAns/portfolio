    ...
    <main v-if="article" class="max-w-[1280px] mx-auto px-[20px] mt-[40px] text-black dark:text-white">
        ...
        <div class="mb-12">
            ...
            <div class="flex items-center gap-6 text-sm text-gray-500 dark:text-gray-400">
                ...
                <a :href="`https://dev.to/elvisans/exploring-the-basis-of-the-intersectionobserver-api-17cb`" target="_blank" class="flex items-center gap-1">
        ...
        <div class="flex items-center gap-4 mb-12">
            ...
            <a :href="`https://twitter.com/intent/tweet?text=Exploring the Basis of the IntersectionObserver API&url=${currentUrl}`" target="_blank"
        ...
        <div class="flex items-center gap-4 mb-12 prose dark:prose-invert prose-lg">
            <p>You can like and comment this article on <a :href="`https://dev.to/elvisans/exploring-the-basis-of-the-intersectionobserver-api-17cb`"
...
const { setSeo } = useSeo()
setSeo({
    title: `Exploring the Basis of the IntersectionObserver API | Ansima's Blog`,
    description: `The web continues to evolve and features such as infinite scrolling and lazy loading images are no...`,
    image: `https://media2.dev.to/dynamic/image/width=1000,height=500,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Fj8zxhozn46wrgegmo4k2.jpg`,
    type: 'article'
})
...
onMounted(async () => {
    try {
        const articleResponse = await fetch(`https://dev.to/api/articles/elvisans/exploring-the-basis-of-the-intersectionobserver-api-17cb`)
