    ...
    <main v-if="article" class="max-w-[1280px] mx-auto px-[20px] mt-[40px] text-black dark:text-white">
        ...
        <div class="mb-12">
            ...
            <div class="flex items-center gap-6 text-sm text-gray-500 dark:text-gray-400">
                ...
                <a :href="`https://dev.to/elvisans/how-to-validate-ai-api-responses-with-zod-and-ajv-and-avoid-breaking-your-frontend-30b`" target="_blank" class="flex items-center gap-1">
        ...
        <div class="flex items-center gap-4 mb-12">
            ...
            <a :href="`https://twitter.com/intent/tweet?text=How to Validate AI API Responses with Zod and AJV (and Avoid Breaking Your Frontend)&url=${currentUrl}`" target="_blank"
        ...
        <div class="flex items-center gap-4 mb-12 prose dark:prose-invert prose-lg">
            <p>You can like and comment this article on <a :href="`https://dev.to/elvisans/how-to-validate-ai-api-responses-with-zod-and-ajv-and-avoid-breaking-your-frontend-30b`"
...
const { setSeo } = useSeo()
setSeo({
    title: `How to Validate AI API Responses with Zod and AJV (and Avoid Breaking Your Frontend) | Ansima's Blog`,
    description: `Why Validate API Responses from AI?   Integrating AI APIs (like OpenAI, Gemini, or Claude)...`,
    image: `https://media2.dev.to/dynamic/image/width=1000,height=500,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Fkjfv2333sgnrumjtq0xq.png`,
    type: 'article'
})
...
onMounted(async () => {
    try {
        const articleResponse = await fetch(`https://dev.to/api/articles/elvisans/how-to-validate-ai-api-responses-with-zod-and-ajv-and-avoid-breaking-your-frontend-30b`)
