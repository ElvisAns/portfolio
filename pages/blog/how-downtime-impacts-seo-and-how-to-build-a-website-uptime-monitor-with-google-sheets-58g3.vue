    ...
    <main v-if="article" class="max-w-[1280px] mx-auto px-[20px] mt-[40px] text-black dark:text-white">
        ...
        <div class="mb-12">
            ...
            <div class="flex items-center gap-6 text-sm text-gray-500 dark:text-gray-400">
                ...
                <a :href="`https://dev.to/elvisans/how-downtime-impacts-seo-and-how-to-build-a-website-uptime-monitor-with-google-sheets-58g3`" target="_blank" class="flex items-center gap-1">
        ...
        <div class="flex items-center gap-4 mb-12">
            ...
            <a :href="`https://twitter.com/intent/tweet?text=How Downtime Impacts SEO (and How to Build a Website Uptime Monitor with Google Sheets)&url=${currentUrl}`" target="_blank"
        ...
        <div class="flex items-center gap-4 mb-12 prose dark:prose-invert prose-lg">
            <p>You can like and comment this article on <a :href="`https://dev.to/elvisans/how-downtime-impacts-seo-and-how-to-build-a-website-uptime-monitor-with-google-sheets-58g3`"
...
const { setSeo } = useSeo()
setSeo({
    title: `How Downtime Impacts SEO (and How to Build a Website Uptime Monitor with Google Sheets) | Ansima's Blog`,
    description: `Typically, we have dozens of sites we have deployed on the Internet, but things can happen that cause...`,
    image: `https://media2.dev.to/dynamic/image/width=1000,height=500,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Fje8s0375cr2deqx53vgf.png`,
    type: 'article'
})
...
onMounted(async () => {
    try {
        const articleResponse = await fetch(`https://dev.to/api/articles/elvisans/how-downtime-impacts-seo-and-how-to-build-a-website-uptime-monitor-with-google-sheets-58g3`)
