    ...
    <main v-if="article" class="max-w-[1280px] mx-auto px-[20px] mt-[40px] text-black dark:text-white">
        ...
        <div class="mb-12">
            ...
            <div class="flex items-center gap-6 text-sm text-gray-500 dark:text-gray-400">
                ...
                <a :href="`https://dev.to/elvisans/pourquoi-changer-sera-difficile-reflexion-personnelle-11ak`" target="_blank" class="flex items-center gap-1">
        ...
        <div class="flex items-center gap-4 mb-12">
            ...
            <a :href="`https://twitter.com/intent/tweet?text=Pourquoi changer sera difficile… (Réflexion personnelle)&url=${currentUrl}`" target="_blank"
        ...
        <div class="flex items-center gap-4 mb-12 prose dark:prose-invert prose-lg">
            <p>You can like and comment this article on <a :href="`https://dev.to/elvisans/pourquoi-changer-sera-difficile-reflexion-personnelle-11ak`"
...
const { setSeo } = useSeo()
setSeo({
    title: `Pourquoi changer sera difficile… (Réflexion personnelle) | Ansima's Blog`,
    description: `Il m’arrive souvent, entre deux lignes de code, deux features à shipper ou deux idées de startup; de...`,
    image: `https://media2.dev.to/dynamic/image/width=1000,height=500,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Fg7po5k0f4n8a2xvausto.jpg`,
    type: 'article'
})
...
onMounted(async () => {
    try {
        const articleResponse = await fetch(`https://dev.to/api/articles/elvisans/pourquoi-changer-sera-difficile-reflexion-personnelle-11ak`)
