    ...
    <main v-if="article" class="max-w-[1280px] mx-auto px-[20px] mt-[40px] text-black dark:text-white">
        ...
        <div class="mb-12">
            ...
            <div class="flex items-center gap-6 text-sm text-gray-500 dark:text-gray-400">
                ...
                <a :href="`https://dev.to/elvisans/an-approach-to-detect-when-a-form-is-submitted-in-webflow-using-mutation-observer-33j7`" target="_blank" class="flex items-center gap-1">
        ...
        <div class="flex items-center gap-4 mb-12">
            ...
            <a :href="`https://twitter.com/intent/tweet?text=An approach to detect when a form is submitted in Webflow using mutation observer&url=${currentUrl}`" target="_blank"
        ...
        <div class="flex items-center gap-4 mb-12 prose dark:prose-invert prose-lg">
            <p>You can like and comment this article on <a :href="`https://dev.to/elvisans/an-approach-to-detect-when-a-form-is-submitted-in-webflow-using-mutation-observer-33j7`"
...
const { setSeo } = useSeo()
setSeo({
    title: `An approach to detect when a form is submitted in Webflow using mutation observer | Ansima's Blog`,
    description: `If you've used Webflow and Webflow forms before, you'll know how simple it is to get a form up and...`,
    image: `https://media2.dev.to/dynamic/image/width=1000,height=500,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Funvz61bz4oa5tgpnbcb6.jpg`,
    type: 'article'
})
...
onMounted(async () => {
    try {
        const articleResponse = await fetch(`https://dev.to/api/articles/elvisans/an-approach-to-detect-when-a-form-is-submitted-in-webflow-using-mutation-observer-33j7`)
